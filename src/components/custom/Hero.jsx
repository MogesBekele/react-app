...
const Hero = () => {
  return (
    <div className=" text-gray-800 p-8 flex flex-col items-center justify-center min-h-screen animate-fade-in">
      ...
      <Link to={'/create-trip'}>  <button className="bg-gray-300 text-gray-900 px-4 py-2 md:px-6 md:py-3 rounded-full font-semibold hover:bg-gray-200 transition-colors animate-fade-in">
        Get Started
      </button></Link>
